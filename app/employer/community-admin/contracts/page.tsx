  ...
  return (
    <CommunityAdminRoute>
      <DashboardPortalShell
        ...
        actions={
          attentionOnly ? (
            <Link href="/employer/community-admin/contracts">
          ...
          visible.map((c) => (
            <Card key={c.id} className="mb-3">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <Link
                    href={hrefWithReturn(`/employer/community-admin/contracts/${c.id}`)}
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Link href={hrefWithReturn(`/employer/community-admin/contracts/${c.id}`)}>
                  <Button variant="outline" size="sm">
                    View Contract
                  </Button>
                </Link>
