...
function JobDetailContent() {
  ...
  const jobsListFallback = buildFilteredPath("/employer/community-admin/jobs", {});
      ...
      {loading || !job ? (
        ...
        <Card>
          ...
          {job.status === "open" && communityId && (
            canApply ? (
              <Link href={hrefWithReturn(`/employer/community-admin/jobs/${jobId}/apply`)} className="mt-4 inline-block">
