...
function MyCommunityContent() {
  ...
  const pendingListHref = buildFilteredPath("/employer/community-admin/my-community", {
    tab: "pending",
  });
  const belowMinimum =
    ...
    <CommunityAdminRoute>
      ...
      >
        ...
        <div className="mb-6 flex gap-2">
          <Link
            href={buildFilteredPath("/employer/community-admin/my-community", {
              tab: "members",
            })}
          >
            <Button
            ...
            pending.map((m) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    href={hrefWithReturn(
                      `/employer/community-admin/my-community/pending/${m.id}`,
                    )}
                  >
