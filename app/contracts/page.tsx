...
import { posterApproveDeliverable, getContracts } from "@/services/contract";
...
function ContractsListContent() {
  ...
  return (
    ...
    <AuthenticatedRoute>
      ...
      <DashboardPortalShell title="My Contracts" subtitle="Review deliverables and release payment">
